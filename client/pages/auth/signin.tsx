        ...
        <div className='flex flex-col items-center justify-center w-full h-4/5'>
          <div className='flex flex-col w-1/2 max-w-md px-16 pt-16 authDialog rounded-3xl'>
            ...
            <div className='flex justify-around mb-2'>
              <div>
                <input type="checkbox" id="male" name="male" style={{"accentColor": "black"}} className='scale-125' />
                <label htmlFor="male" className='ml-2 text-white'>male: 男性</label>
              </div>

              <div>
                <input type="checkbox" id="female" name="female" style={{"accentColor": "black"}}  className='scale-125' />
                <label htmlFor="female" className='ml-2 text-white'>female: 女性</label>
              </div>
            </div>
            
            <label htmlFor="age" className='text-white'>Age: 年齢*</label>
            <input type="number" id="age" name="age" min="0" className='w-20 pl-3 mt-1 mb-6 text-center rounded-3xl' />

            <div className='flex justify-around mb-6'>
              <button className='px-3 py-1 text-white bg-gray-800 rounded-lg'>
                <p className='font-bold'>Cancel</p>
              </button>
              <button className='px-3 py-1 rounded-lg bg-gray-50 text-grey-800'>
