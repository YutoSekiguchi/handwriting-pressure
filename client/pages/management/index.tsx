...
const ManagementPage: NextPage = () => {
  ...
  const [noteListWithNotPressureUndo, setNoteListWithNotPressureUndo] =
    useState([]);
  ...
  useEffect(() => {
    if (paperDetails.state.paperDetailsWithPressureUndoList?.length > 0) {
      setNoteListWithPressureUndo(
        paperDetails.state.paperDetailsWithPressureUndoList
      );
    }
    if (paperDetails.state.paperDetailsWithNotPressureUndoList?.length > 0) {
      setNoteListWithNotPressureUndo(
        paperDetails.state.paperDetailsWithNotPressureUndoList
      );
    }
                        ...
                        {String(note["Title"]).indexOf(title) !== -1 && (
                          <div className="mb-3 mr-4">
                            ...
                            <div className="flex items-center justify-center">
                              <p className="mr-2 text-center text-white">
                                {note["Title"]}
                              </p>
